...
public extension DatamanClient {
    ...
    func fetchFormEvents(
        ...
        streamEvents(siteId: siteId, from: from, to: to, types: ["form_start","form_step_view","form_submit", "form_submit_success", "form_submit_failure","form_validation_error"], on: req)
